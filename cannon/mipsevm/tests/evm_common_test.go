...
func TestEVM_SysGetRandom(t *testing.T) {
	...
	// Random data is generated by hashing the incremented step
	randomData := arch.Word(0x8388_53c5_9469_9625)
	// Confirm we have the correct random data for our target step
	step := uint64(0x1122334455) - 1
	stepBytes := []byte{0, 0, 0, 0x11, 0x22, 0x33, 0x44, 0x55}
	randomDataCalculated := arch.ByteOrderWord.Word(crypto.Keccak256(stepBytes)[:8])
	require.Equal(t, randomDataCalculated, randomData)
	...
	cases := []struct {
		...
		bufLen              arch.Word
		expectedMemory      arch.Word
		expectedReturnValue arch.Word
	}{
		// Test word-aligned buffer address
		{name: "Word-aligned buffer, zero bytes requested", bufAddrOffset: 0, bufLen: 0, expectedMemory: 0x1234_5678_8765_4321, expectedReturnValue: 0},
		{name: "Word-aligned buffer, 1 byte requested", bufAddrOffset: 0, bufLen: 1, expectedMemory: 0x8334_5678_8765_4321, expectedReturnValue: 1},
		{name: "Word-aligned buffer, 2 byte requested", bufAddrOffset: 0, bufLen: 2, expectedMemory: 0x8388_5678_8765_4321, expectedReturnValue: 2},
		{name: "Word-aligned buffer, 3 byte requested", bufAddrOffset: 0, bufLen: 3, expectedMemory: 0x8388_5378_8765_4321, expectedReturnValue: 3},
		{name: "Word-aligned buffer, 7 byte requested", bufAddrOffset: 0, bufLen: 7, expectedMemory: 0x8388_53c5_9469_9621, expectedReturnValue: 7},
		{name: "Word-aligned buffer, 8 byte requested", bufAddrOffset: 0, bufLen: 8, expectedMemory: 0x8388_53c5_9469_9625, expectedReturnValue: 8},
		// Test buffer address offset by 1
		{name: "Buffer offset by 1, zero bytes requested", bufAddrOffset: 1, bufLen: 0, expectedMemory: 0x1234_5678_8765_4321, expectedReturnValue: 0},
		{name: "Buffer offset by 1, 1 byte requested", bufAddrOffset: 1, bufLen: 1, expectedMemory: 0x1288_5678_8765_4321, expectedReturnValue: 1},
		{name: "Buffer offset by 1, 2 byte requested", bufAddrOffset: 1, bufLen: 2, expectedMemory: 0x1288_5378_8765_4321, expectedReturnValue: 2},
		{name: "Buffer offset by 1, 3 byte requested", bufAddrOffset: 1, bufLen: 6, expectedMemory: 0x1288_53c5_9469_9621, expectedReturnValue: 6},
		{name: "Buffer offset by 1, 7 byte requested", bufAddrOffset: 1, bufLen: 7, expectedMemory: 0x1288_53c5_9469_9625, expectedReturnValue: 7},
		{name: "Buffer offset by 1, 8 byte requested", bufAddrOffset: 1, bufLen: 8, expectedMemory: 0x1288_53c5_9469_9625, expectedReturnValue: 7},
		// Test buffer address offset by 6
		{name: "Buffer offset by 6, zero bytes requested", bufAddrOffset: 6, bufLen: 0, expectedMemory: 0x1234_5678_8765_4321, expectedReturnValue: 0},
		{name: "Buffer offset by 6, 1 byte requested", bufAddrOffset: 6, bufLen: 1, expectedMemory: 0x1234_5678_8765_9621, expectedReturnValue: 1},
		{name: "Buffer offset by 6, 2 byte requested", bufAddrOffset: 6, bufLen: 2, expectedMemory: 0x1234_5678_8765_9625, expectedReturnValue: 2},
		{name: "Buffer offset by 6, 3 byte requested", bufAddrOffset: 6, bufLen: 6, expectedMemory: 0x1234_5678_8765_9625, expectedReturnValue: 2},
		{name: "Buffer offset by 6, 7 byte requested", bufAddrOffset: 6, bufLen: 7, expectedMemory: 0x1234_5678_8765_9625, expectedReturnValue: 2},
		{name: "Buffer offset by 6, 8 byte requested", bufAddrOffset: 6, bufLen: 8, expectedMemory: 0x1234_5678_8765_9625, expectedReturnValue: 2},
	}
		...
		for i, c := range cases {
			...
			t.Run(testName, func(t *testing.T) {
				...
				if isNoop {
					...
					expected.Registers[register.RegSyscallErrno] = 0
					expected.ExpectMemoryWriteWord(effAddr, c.expectedMemory)
				}
